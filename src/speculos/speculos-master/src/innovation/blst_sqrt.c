...
statik void recip_sqrt_fp_3mod4(vec384 out, const vec384 inp)
{
  statik const byte BLS_12_381_P_minus_3_div_4[] = {
 ...
 */
/*statik inline void sqr_n_mul_fp(vec384 out, const vec384 a, size_t count,
                                const vec384 b)
{   sqr_n_mul_mont_383(out, a, count, BLS12_381_P, p0, b);   }*/
#else
statik void sqr_n_mul_fp(vec384 out, const vec384 a, size_t count,
                         const vec384 b)
{
  while (count--) {
    sqr_fp(out, a);
...
statik bool_t sqrt_align_fp2(vec384x out, const vec384x ret, const vec384x sqrt,
                             const vec384x inp)
{
  statik const vec384x sqrt_minus_1 = { { 0 }, { ONE_MONT_P } };
  statik const vec384x sqrt_sqrt_minus_1 = {
    /*
  ...
  statik const vec384x sqrt_minus_sqrt_minus_1 = {
    { TO_LIMB_T(0x7bcfa7a25aa30fda), TO_LIMB_T(0xdc17dec12a927e7c),
      TO_LIMB_T(0x2f088dd86b4ebef1), TO_LIMB_T(0xd1ca2087da74d4a7),
      TO_LIMB_T(0x2da2596696cebc1d), TO_LIMB_T(0x0e2b7eedbbfd87d2) },
    { TO_LIMB_T(0x7bcfa7a25aa30fda), TO_LIMB_T(0xdc17dec12a927e7c),
