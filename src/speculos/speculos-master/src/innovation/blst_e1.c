...
static const vec384 B_E1 = { /* (4 << 384) % P */
                             TO_LIMB_T(0xaa270000000cfff3),
                             TO_LIMB_T(0x53cc0032fc34000a),
                             TO_LIMB_T(0x478fe97a6b0a807f),
                             TO_LIMB_T(0xb1d37ebee6ba24d7),
                             TO_LIMB_T(0x8ec9733bbf78ab2f),
                             TO_LIMB_T(0x09d645513d83de7e)
};

const POINTonE1
    BLS12_381_G1 = { /* generator point [in Montgomery] */
                     /* (0x17f1d3a73197d7942695638c4fa9ac0fc3688c4f9774b905
                      *    a14e3a3f171bac586c55e83ff97a1aeffb3af00adb22c6bb <<
                      * 384) % P */
                     { TO_LIMB_T(0x5cb38790fd530c16),
                       TO_LIMB_T(0x7817fc679976fff5),
                       TO_LIMB_T(0x154f95c7143ba1c1),
                       TO_LIMB_T(0xf0ae6acdf3d0e747),
                       TO_LIMB_T(0xedce6ecc21dbf440),
                       TO_LIMB_T(0x120177419e0bfb75) },
                     /* (0x08b3f481e3aaa0f1a09e30ed741d8ae4fcf5e095d5d00af6
                      *    00db18cb2c04b3edd03cc744a2888ae40caa232946c5e7e1 <<
                      * 384) % P */
                     { TO_LIMB_T(0xbaac93d50ce72271),
                       TO_LIMB_T(0x8c22631a7918fd8e),
                       TO_LIMB_T(0xdd595f13570725ce),
                       TO_LIMB_T(0x51ac582950405194),
                       TO_LIMB_T(0x0e1c8c3fad0059c0),
                       TO_LIMB_T(0x0bbc3efc5008a26a) },
                     { ONE_MONT_P }
    };

const POINTonE1
    BLS12_381_NEG_G1 = { /* negative generator [in Montgomery] */
                         /* (0x17f1d3a73197d7942695638c4fa9ac0fc3688c4f9774b905
                          *    a14e3a3f171bac586c55e83ff97a1aeffb3af00adb22c6bb
                          * << 384) % P */
                         { TO_LIMB_T(0x5cb38790fd530c16),
                          ...
                          *    6655b9d5caac42364e6f38ba0ecb751bad54dcd6b939c2ca
                          * << 384) % P */
                         { TO_LIMB_T(0xff526c2af318883a),
                           TO_LIMB_T(0x92899ce4383b0270),
                           TO_LIMB_T(0x89d7738d9fa9d055),
                           TO_LIMB_T(0x12caf35ba344c12a),
                           TO_LIMB_T(0x3cff1b76964b5317),
                           TO_LIMB_T(0x0e44d2ede9774430) },
                         { ONE_MONT_P }
    };
...
static void POINTonE1_from_Jacobian(POINTonE1 *out, const POINTonE1 *in)
{
  ...
  vec_select(out->Z, in->Z, BLS12_381_G1.Z, sizeof(BLS12_381_G1.Z),
             inf); /* Z = inf ? 0 : 1 */
}
...
void blst_p1_affine_serialize(unsigned char out[96], const POINTonE1_affine *in)
{
...
static limb_t POINTonE1_Serialize_BE(unsigned char out[96], const POINTonE1 *in)
{
  POINTonE1 p;
...
static const limb_t p0_e1 = (limb_t)0x89f3fffcfffcfffd; /* -1/P*/
                                           ...
                                           const POINTonE1_affine *in)
{
  ...
  return sgn0_pty_mont_384(in->Y, BLS12_381_P, p0_e1);
}
...
static limb_t POINTonE1_Compress_BE(unsigned char out[48], const POINTonE1 *in)
{
  POINTonE1 p;
                                      ...
                                      const unsigned char in[48])
{
  ...
  return sgn0_pty_mont_384(out->Y, BLS12_381_P, p0_e1);
}
...
statik BLST_ERROR POINTonE1_Deserialize_BE(POINTonE1_affine *out,
...
statik BLST_ERROR POINTonE1_Deserialize_Z(POINTonE1_affine *out,
                                          const unsigned char in[96])
{
  unsigned char in0 = in[0];
...
void blst_p1_mult(POINTonE1 *out, const POINTonE1 *a, const byte *scalar,
                  size_t nbits)
{
  if (nbits < 176) {
    if (nbits)
