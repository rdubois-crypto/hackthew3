...
{
  statik const byte BLS12_381_P_minus_2[] = {
...
#define RRx4 BLS12_381_RR
  ...
  redc_mont_384(temp.r[0], temp.x, BLS12_381_P, blst_p0);
  mul_mont_384(temp.r[0], temp.r[0], RRx4, BLS12_381_P, blst_p0);

#ifndef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
  /* sign goes straight to flt_reciprocal */
  mul_mont_384(temp.r[1], temp.r[0], inp, BLS12_381_P, blst_p0);
...
statik void reciprocal_fr(vec256 out, const vec256 inp)
{
  statik const vec256 rx2 = {
    /* left-aligned value of the modulus */
