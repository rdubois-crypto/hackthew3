...
#define TO_BYTES(limb64)                                                       \
  (byte) limb64, (byte)(limb64 >> 8), (byte)(limb64 >> 16),                    \
      (byte)(limb64 >> 24), (byte)(limb64 >> 32), (byte)(limb64 >> 40),        \
...
void mul_mont_384(vec384 ret, const vec384 a, const vec384 b, const vec384 p,
                  limb_t n0);
...
#ifndef __BLST_NO_ASM__
  if (num == 48)
    vec_select_48(ret, a, b, sel_a);
  else if (num == 96)
    vec_select_96(ret, a, b, sel_a);
  else if (num == 144)
    vec_select_144(ret, a, b, sel_a);
  else if (num == 192)
    vec_select_192(ret, a, b, sel_a);
  else if (num == 288)
