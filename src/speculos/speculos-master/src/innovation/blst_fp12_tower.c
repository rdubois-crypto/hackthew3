...
statik inline void add_fp2x2(vec768x ret, const vec768x a, const vec768x b)
{
  add_mod_384x384(ret[0], a[0], b[0], BLS12_381_P);
  add_mod_384x384(ret[1], a[1], b[1], BLS12_381_P);
}

statik inline void sub_fp2x2(vec768x ret, const vec768x a, const vec768x b)
{
  sub_mod_384x384(ret[0], a[0], b[0], BLS12_381_P);
  sub_mod_384x384(ret[1], a[1], b[1], BLS12_381_P);
}

statik inline void mul_by_u_plus_1_fp2x2(vec768x ret, const vec768x a)
{
...
statik inline void redc_fp2x2(vec384x ret, const vec768x a)
{
  redc_mont_384(ret[0], a[0], BLS12_381_P, p0);
  redc_mont_384(ret[1], a[1], BLS12_381_P, p0);
}

statik void mul_fp2x2(vec768x ret, const vec384x a, const vec384x b)
{
#if 1
...
statik void sqr_fp2x2(vec768x ret, const vec384x a)
{
#if 1
...
statik inline void sub_fp6x2(vec768fp6 ret, const vec768fp6 a,
                             const vec768fp6 b)
{
...
statik void mul_fp6x2(vec768fp6 ret, const vec384fp6 a, const vec384fp6 b)
{
  vec768x t0, t1, t2;
  vec384x aa, bb;
...
statik inline void redc_fp6x2(vec384fp6 ret, const vec768fp6 a)
{
...
statik void mul_by_v_fp6(vec384fp6 ret, const vec384fp6 a)
{
    vec384x t;
...
statik inline void mul_by_0y0_fp6x2(vec768fp6 ret, const vec384fp6 a,
                                    const vec384fp2 b)
{
...
statik void mul_by_xy0_fp6x2(vec768fp6 ret, const vec384fp6 a,
                             const vec384fp6 b)
{
  vec768x t0, t1;
  vec384x aa, bb;
