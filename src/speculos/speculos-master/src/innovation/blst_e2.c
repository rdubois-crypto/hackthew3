...
const POINTonE2
    BLS12_381_G2 = {   /* generator point [in Montgomery] */
                     { /* (0x024aa2b2f08f0a91260805272dc51051c6e47ad4fa403b02
                             b4510b647ae3d1770bac0326a805bbefd48056c8c121bdb8 <<
                          384) % P */
                       { TO_LIMB_T(0xf5f28fa202940a10),
                         TO_LIMB_T(0xb3f5fb2687b4961a),
                         TO_LIMB_T(0xa1a893b53e2ae580),
                         TO_LIMB_T(0x9894999d1a3caee9),
                         TO_LIMB_T(0x6f67b7631863366b),
                         TO_LIMB_T(0x058191924350bcd7) },
                       /* (0x13e02b6052719f607dacd3a088274f65596bd0d09920b61a
                             b5da61bbdc7f5049334cf11213945d57e5ac7d055d042b7e <<
                          384) % P */
                       { TO_LIMB_T(0xa5a9c0759e23f606),
                         TO_LIMB_T(0xaaa0c59dbccd60c3),
                         TO_LIMB_T(0x3bb17e18e2867806),
                         TO_LIMB_T(0x1b1ab6cc8541b367),
                         TO_LIMB_T(0xc2b6ed0ef2158547),
                         TO_LIMB_T(0x11922a097360edf3) } },
                     {
                         ...
                         { TO_LIMB_T(0x4c730af860494c4a),
                           TO_LIMB_T(0x597cfa1f5e369c5a),
                           TO_LIMB_T(0xe7e6856caa0a635a),
                           TO_LIMB_T(0xbbefb5e96e0d495f),
                           TO_LIMB_T(0x07d3a975f0ef25a2),
                           TO_LIMB_T(0x0083fd8e7e80dae5) },
                         /* (0x0606c4a02ea734cc32acd2b02bc28b99cb3e287e85a763af
                               267492ab572e99ab3f370d275cec1da1aaa9075ff05f79be
                            << 384) % P */
                         { TO_LIMB_T(0xadc0fc92df64b05d),
                           TO_LIMB_T(0x18aa270a2b1461dc),
                           TO_LIMB_T(0x86adac6a3be4eba0),
                           TO_LIMB_T(0x79495c4ec93da33a),
                           TO_LIMB_T(0xe7175850a43ccaed),
                           TO_LIMB_T(0x0b2bc2a163de1bf2) },
                     },
                     { { ONE_MONT_P }, { 0 } }
    };

const POINTonE2
    BLS12_381_NEG_G2 = {   /* negative generator [in Montgomery] */
                         { /* (0x024aa2b2f08f0a91260805272dc51051c6e47ad4fa403b02
                                 b4510b647ae3d1770bac0326a805bbefd48056c8c121bdb8
                              << 384) % P */
                           { TO_LIMB_T(0xf5f28fa202940a10),
                         ...
                         { /* (0x0d1b3cc2c7027888be51d9ef691d77bcb679afda66c73f17
                                 f9ee3837a55024f78c71363275a75d75d86bab79f74782aa
                              << 384) % P */
                           { TO_LIMB_T(0x6d8bf5079fb65e61),
                             TO_LIMB_T(0xc52f05df531d63a5),
                             TO_LIMB_T(0x7f4a4d344ca692c9),
                             TO_LIMB_T(0xa887959b8577c95f),
                             TO_LIMB_T(0x4347fe40525c8734),
                             TO_LIMB_T(0x197d145bbaff0bb5) },
                           /* (0x13fa4d4a0ad8b1ce186ed5061789213d993923066dddaf10
                                 40bc3ff59f825c78df74f2d75467e25e0f55f8a00fa030ed
                              << 384) % P */
                           { TO_LIMB_T(0x0c3e036d209afa4e),
                             TO_LIMB_T(0x0601d8f4863f9e23),
                             TO_LIMB_T(0xe0832636bacc0a84),
                             TO_LIMB_T(0xeb2def362a476f84),
                             TO_LIMB_T(0x64044f659f0ee1e9),
                             TO_LIMB_T(0x0ed54f48d5a1caa7) } },
                         { { ONE_MONT_P }, { 0 } }
    };
...
static void POINTonE2_from_Jacobian(POINTonE2 *out, const POINTonE2 *in)
{
  ...
  vec_select(out->Z, in->Z, BLS12_381_G2.Z, sizeof(BLS12_381_G2.Z),
             inf); /* Z = inf ? 0 : 1 */
}
                                           ...
                                           const POINTonE2_affine *in)
{
  ...
  return sgn0_pty_mont_384x(in->Y, BLS12_381_P, blst_p0);
}
...
static limb_t POINTonE2_Compress_BE(unsigned char out[96], const POINTonE2 *in)
{
  POINTonE2 p;
                                      ...
                                      const unsigned char in[96])
{
  ...
  return sgn0_pty_mont_384x(out->Y, BLS12_381_P, blst_p0);
}
...
{
  static const vec384x frobenius_x = {
    /* 1/(1 + i)^((P-1)/3) */
    { 0 },
  ...
  static const vec384x frobenius_y = {
    /* 1/(1 + i)^((P-1)/2) */
  ...
  vec_copy(out, in, sizeof(*out));
  cneg_fp(out->X[1], out->X[1], 1);
  mul_fp2(out->X, out->X, frobenius_x);
  cneg_fp(out->Y[1], out->Y[1], 1);
  mul_fp2(out->Y, out->Y, frobenius_y);
...
void blst_p2_mult(POINTonE2 *out, const POINTonE2 *a, const byte *scalar,
                  size_t nbits)
{
  if (nbits < 144) {
    if (nbits)
